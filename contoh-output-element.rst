...
==============================================================
Contoh Output Element Dokumentasi Dengan Tema Read The Docs
==============================================================

.. Above is the document title, and below is the subtitle.
   They are transformed from section titles after parsing.

File ini merupakan bagian dari `reStructuredText Demonstration` yang terdapat di http://docutils.sourceforge.net/docs/user/rst/demo.html
...
.. attention::
    ...
    `Table Of Content` (TOC) dibawah ini tidak menghubungkan ke file lain namun dalam section pada halaman ini.
    ...
    Untuk `.. section-numbering::` digunakan untuk penomoran setiap section. penomoran ini akan menggunakan angka arab dengan memberikan `parent number` di depan section.

    Dan Section yang akan dibuatakan di dalam `Table Of Content` TOC ini berasal dari semua section (termasuk section yang berada di atas directive ini)
...
.. figure:: resources/images/title.png
...
.. |EXAMPLE| image:: resources/images/biohazard.png
